...
export const getFiltro = (observer, idBomba, Cedula) => {
  console.error(Cedula);
  console.error(idBomba);
  return db.collection("HOSPITALES").doc(idBomba).collection("Pacientes").where("Cedula", "==", Cedula.toString()).onSnapshot(observer);
};
