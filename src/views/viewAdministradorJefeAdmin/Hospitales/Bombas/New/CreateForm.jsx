...
const CreateForm = ({
  ...
  return <Formik initialValues={{
    ...
    NombrePaciente: data?.data().NombrePaciente || "",
    CedulaPaciente: data?.data().CedulaPaciente || ""
    ...
    try {
      ...
      values.NombreEncargado = habitacion.data().NombreEncargado;
      values.Valor = 0;
      values.duracion = 0;
