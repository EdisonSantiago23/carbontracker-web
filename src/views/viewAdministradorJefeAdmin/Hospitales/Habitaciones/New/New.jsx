...
import PersonAddIcon from "@mui/icons-material/MeetingRoom";
...
function New(props) {
  ...
  console.log('xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx', props);
  return <div>
          ...
          <div className={classes.paper}>
            <Page className={classes.root} title="CrearCuenta">
              <Container maxWidth="lg">
                ...
                <CreateForm data={props.data} info={props.info} areaId={props.areaId} send={() => handleClose()} />
              </Container>
            </Page>
          </div>
        </Fade>
