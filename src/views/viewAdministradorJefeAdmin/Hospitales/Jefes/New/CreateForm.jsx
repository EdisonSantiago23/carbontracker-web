...
import { Box, Button, CircularProgress, Grid, TextField,  InputAdornment } from "@mui/material";
          ...
          {loading ? <Box display="flex" justifyContent="center" my={5}>
              ...
              <Grid container spacing={3}>
                <Grid item xs={12} lg={6}>
                  <TextField error={errors.Nombre && touched.Nombre} helperText={errors.Nombre && touched.Nombre && errors.Nombre} label="Nombre" name="Nombre" placeholder="Nombre" variant="outlined" fullWidth="true" value={values.Nombre} onChange={handleChange} onBlur={handleBlur} />
                </Grid>
                <Grid item xs={12} lg={6}>
              ...
              <Grid container spacing={3}>
                <Grid item xs={12} lg={6}>
                  <TextField error={errors.Correo && touched.Correo} helperText={errors.Correo && touched.Correo && errors.Correo} label="Correo" name="Correo" placeholder="Correo" variant="outlined" fullWidth="true" value={values.Correo} onChange={handleChange} onBlur={handleBlur} />
                </Grid>
                <Grid item xs={12} lg={6}>
                  <TextField error={errors.Cedula && touched.Cedula} helperText={errors.Cedula && touched.Cedula && errors.Cedula} label="Cedula" name="Cedula" placeholder="Cedula" variant="outlined" fullWidth="true" value={values.Cedula} onChange={handleChange} onBlur={handleBlur} />
                </Grid>
