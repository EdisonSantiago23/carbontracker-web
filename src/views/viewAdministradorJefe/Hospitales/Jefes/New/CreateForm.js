...
const CreateForm = ({
  ...
  return <Formik initialValues={{
    ...
    try {
      ...
      values.Rol = '{ "administrador": false, "superAdministrador": false, "jefe": true,"jefeAdmin": false}';
      ...
      values
          ...
          {loading ? <Box display="flex" justifyContent="center" my={5}>
              ...
              <Grid container spacing={3}>
                ...
                <Grid item xs={12} lg={6}>
                  <select name="color" value={values.color} onChange={handleChange} onBlur={handleBlur} style={{
              display: "block"
            }}>
