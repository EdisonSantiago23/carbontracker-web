...
export default function CustomInput(props) {
  ...
  return <FormControl {...formControlProps} className={formControlProps.className + " " + classes.formControl}>
      {labelText !== undefined ? <InputLabel className={classes.labelRoot + labelClasses} htmlFor={id} {...labelProps}>
          {labelText}
        </InputLabel> : null}
      <Input classes={{
      root: marginTop,
    ...
    }} id={id} name={name} {...inputProps} inputProps={newInputProps} />
